...
const SCENE_KEYS = [
  ...
  { value: 'exercise_gen', label: '练习题生�? },
  { value: 'content_summary', label: '内容摘要' },
  { value: 'knowledge_explain', label: '知识点讲�? },
    ...
    <div>
      ...
      >
        <Form form={form} layout="vertical">
          <Form.Item name="scene_key" label="场景标识" rules={[{ required: true, message: '请选择或输入场景标�? }]}>
            <Select
              showSearch
              placeholder="选择或输入场景标�?
              options={SCENE_KEYS}
              disabled={!!editing}
            />
          </Form.Item>
