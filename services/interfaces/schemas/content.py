"""
Content Engine Pydantic schemas
────────────────────────────────
教材、章节、知识点、资源生成、练习题、Prompt 模板
"""
...
class GenerateResourceRequest(BaseModel):
    ...
    resource_type: str = Field(
        ..., description="quiz/game/video_script/summary/exercise"
    )
...
class ExerciseCreate(BaseModel):
    ...
    knowledge_point_id: UUID
    exercise_type: str = Field(
        default="choice", description="choice/fill_blank/short_answer/true_false"
    )
