...
r1 = httpx.get("https://sydney-gba-albuquerque-shoppers.trycloudflare.com/api/v1/admin/tutor/conversations?page=1&page_size=20", headers=headers)
print(f"Status: {r1.status_code}")
print(f"Response: {r1.text}\n")

print("=== Testing textbooks ===")
r2 = httpx.get("https://sydney-gba-albuquerque-shoppers.trycloudflare.com/api/v1/admin/textbooks", headers=headers)
